            ...
            >
                <View style={{
                    ...
                    <View style={styles.okAndCancelButtonWrapStyle}>
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setFullnameDialog(false)}
        ...
        return (
            ...
            >
                <View style={{
                    ...
                    <View style={styles.okAndCancelButtonWrapStyle}>
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setPasswordDialog(false)}
                            style={styles.cancelButtonStyle}
                        >
        ...
        return (
            ...
            >
                <View style={{
                    ...
                    <View style={styles.okAndCancelButtonWrapStyle}>
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setPhoneDialog(false)}
                            style={styles.cancelButtonStyle}
                        >
                            <Text style={{ ...Fonts.blackColor18Medium }}>Cancel</Text>
                        </TouchableOpacity>
        ...
        return (
            ...
            >
                <View style={{
                    ...
                    <View style={styles.okAndCancelButtonWrapStyle}>
                        <TouchableOpacity activeOpacity={0.6} onPress={() => setEmailDialog(false)}
                            style={styles.cancelButtonStyle}
                        >
                            <Text style={{ ...Fonts.blackColor18Medium }}>Cancel</Text>
                        </TouchableOpacity>
